...
class SmsDemo
{
    ...
    public static function getAcsClient() {
        ...
        $accessKeyId = "LTAInPnNUzm70YRy"; // AccessKeyId

        $accessKeySecret = "SNEI9RqpVll9PudcUz5cUyCNwELbt4"; // AccessKeySecret
    ...
    public static function sendSms($p) {
        ...
        // 必填，设置短信接收号码
        $request->setPhoneNumbers($p);

        // 必填，设置签名名称，应严格按"签名名称"填写，请参考: https://dysms.console.aliyun.com/dysms.htm#/develop/sign
        $request->setSignName("阿里云短信测试专用");

        // 必填，设置模板CODE，应严格按"模板CODE"填写, 请参考: https://dysms.console.aliyun.com/dysms.htm#/develop/template
        $request->setTemplateCode("SMS_125665035");
