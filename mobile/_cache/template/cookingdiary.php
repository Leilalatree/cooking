...
的膳食纤维含量最高，可促进新陈代谢等有机...</p></pre>
            ...
            <li >
                ...
                <div class="content">
                    <span class="page-header" style="font-size: 17px;"><?php e($value["diarytitle"]);?></span>
                    <pre> <p class="section"style="text-indent: 2rem;word-break: break-all;word-wrap: break-word;text-overflow:ellipsis"><?php e($value["diarycontent"]);?></p></pre>
                </div>
                <div class="btn-section">
                    <div class="like" >
                        <img src="images/cookingdiary/likeimage.png">
                    ...
                    <div class="time"style="margin-left: 5%;width: 100px;">
                        <img src="images/cookingdiary/dateimage.png">
                        <p style="width: 70px;"><?php e($value["diarytime"]);?></p>
                    </div>
                </div>
            </li>
            <?php }}?>
